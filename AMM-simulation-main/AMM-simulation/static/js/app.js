...
function initCharts() {
    ...
    priceChart.setOption({
        ...
        xAxis: { type: 'category', data: [], axisLine: { lineStyle: { color: '#253449' } }, axisTick: { show: false } },
        yAxis: { type: 'value', name: 'USDC', axisLine: { show: false }, splitLine: { lineStyle: { color: '#1e2d3d' } }, axisLabel: { formatter: v => fmtPrice(v) } },
        series: [{
            type: 'line', data: [], smooth: true,
            lineStyle: { color: '#00d4aa', width: 2.5 },
            areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: 'rgba(0,212,170,0.2)' }, { offset: 1, color: 'rgba(0,212,170,0.02)' }]) },
            symbol: 'none',
        }],
    });
    ...
    depthChart.setOption({
        ...
        xAxis: { type: 'value', name: 'ETH', axisLine: { lineStyle: { color: '#253449' } }, splitLine: { lineStyle: { color: '#1e2d3d' } } },
        yAxis: { type: 'value', name: 'USDC', axisLine: { show: false }, splitLine: { lineStyle: { color: '#1e2d3d' } }, axisLabel: { formatter: v => fmtShort(v) } },
        series: [{
            type: 'line', data: [], smooth: true,
            lineStyle: { color: '#3b82f6', width: 2 },
            areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: 'rgba(59,130,246,0.15)' }, { offset: 1, color: 'rgba(59,130,246,0.02)' }]) },
            symbol: 'none',
        }],
    });
    ...
    ilChart.setOption({
        ...
        xAxis: { type: 'category', data: [], name: '价格倍数', axisLine: { lineStyle: { color: '#253449' } }, axisTick: { show: false } },
        yAxis: { type: 'value', name: 'IL (%)', axisLine: { show: false }, splitLine: { lineStyle: { color: '#1e2d3d' } }, axisLabel: { formatter: v => v.toFixed(1) + '%' } },
        series: [{
            type: 'line', data: [], smooth: true,
            ...
            symbol: 'none',
            markLine: { data: [{ yAxis: 0, label: { formatter: '盈亏平衡' }, lineStyle: { color: '#566478', type: 'dashed' } }], silent: true },
        }],
    });
    ...
    reservesChart.setOption({
        ...
        xAxis: { type: 'category', data: [], axisLine: { lineStyle: { color: '#253449' } }, axisTick: { show: false } },
        yAxis: [
            { type: 'value', name: 'ETH', axisLine: { show: false }, splitLine: { lineStyle: { color: '#1e2d3d' } } },
            { type: 'value', name: 'USDC', axisLine: { show: false }, splitLine: { show: false } },
        ],
        series: [
            { name: 'ETH', type: 'bar', data: [], itemStyle: { color: '#3b82f6', borderRadius: [4, 4, 0, 0] }, barGap: '30%' },
            { name: 'USDC', type: 'bar', data: [], yAxisIndex: 1, itemStyle: { color: '#22c55e', borderRadius: [4, 4, 0, 0] } },
        ],
    });
    ...
    simPriceChart.setOption({
        ...
        xAxis: { type: 'category', data: [], name: '步骤', axisLine: { lineStyle: { color: '#253449' } }, axisTick: { show: false } },
        yAxis: { type: 'value', name: '价格', axisLine: { show: false }, splitLine: { lineStyle: { color: '#1e2d3d' } } },
        series: [
            { name: 'AMM价格', type: 'line', data: [], smooth: true, lineStyle: { color: '#00d4aa', width: 2 }, symbol: 'none' },
            { name: '预言机价格', type: 'line', data: [], smooth: true, lineStyle: { color: '#f59e0b', width: 2, type: 'dashed' }, symbol: 'none' },
        ],
    });
    ...
    posChart.setOption({
        ...getChartTheme(),
        tooltip: { trigger: 'axis' },
        legend: { data: ['HODL价值', 'LP价值'], textStyle: { color: '#8896a8' }, top: 0 },
        grid: { left: 60, right: 20, top: 40, bottom: 30 },
        xAxis: { type: 'category', data: [], axisLine: { lineStyle: { color: '#253449' } }, axisTick: { show: false } },
        yAxis: { type: 'value', name: 'USDC', axisLine: { show: false }, splitLine: { lineStyle: { color: '#1e2d3d' } }, axisLabel: { formatter: v => fmtShort(v) } },
        series: [
            { name: 'HODL价值', type: 'bar', data: [], itemStyle: { color: '#3b82f6' } },
            { name: 'LP价值', type: 'bar', data: [], itemStyle: { color: '#00d4aa' } },
        ],
    });
...
async function stepSimulation() {
    try {
        const resp = await apiPost('/api/simulation/step');
        if (resp.success) {
            const r = resp.result;
